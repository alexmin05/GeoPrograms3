public class B3_HalfTheRed extends World {
    ...
    public void go() {
        System.out.println(".");
        plane.teleport(0, 0);
        plane.showBackGround(); // method that shows a picture file found on line 12 of RunMyProgram.java
        System.out.println(plane.howMuchRed()); // howMuchRed is a method that tells us the "r" value of the plane's current pixel

        for (int row = 158; row < 214; row = row + 1) {
            for (int col = 143; col < 202; col++) {
